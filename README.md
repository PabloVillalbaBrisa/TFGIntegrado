...
Este repositorio contiene una serie de programas para realizar web scraping, descargar posts de Instagram, extraer conocimiento de imágenes, preparar datos, y realizar análisis estadístico en R. Dichos programas han sido desarrollados para mi TFG Integrado en la Universidad Politécnica de Valencia, y están organizados en diferentes secciones según su fin.
